...
@Component({
    selector: 'staff-student-absence-requests',
    templateUrl: './staff-student-absence-requests.component.html',
})
export class StaffStudentAbsenceRequestsComponent implements OnInit {
